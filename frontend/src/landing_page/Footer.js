    ...
    return ( 
      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            <img src="media/images/logo2.svg" style={{ width: "50%", marginBottom:"10px" }} />
            <p>
              &copy;2024, KSXchange Broking Ltd. All rights reserved.
            </p>
          </div>
          <div className="col">
            <p>Company</p>
            ...
            <br />
            <a href=""  className='text-muted' style={{textDecoration :"none"}}>KSXchange.tech</a>
            <br />
            <a href=""  className='text-muted' style={{textDecoration :"none"}}>Press & media</a>
            <br />
            <a href=""  className='text-muted' style={{textDecoration :"none"}}>KSXchange cares (CSR)</a>
            <br />
          </div>
          <div className="col">
            <p>Support</p>
            ...
            <br />
            <a href=""  className='text-muted' style={{textDecoration :"none"}}>KSX-Connect blog</a>
            <br />
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            KSXchange Broking Ltd.: Member of NSE​ &​ BSE – SEBI Registration no.:
            INZ000031633 CDSL: Depository services through KSXchange Securities
            Pvt. Ltd. – SEBI Registration no.: IN-DP-100-2015 Commodity Trading
            through KSXchange Commodities Pvt. Ltd. MCX: 46025 – SEBI Registration
            no.: INZ000038238 Registered Address: Zerodha Broking Ltd.,
            #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School,
            J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any
            complaints pertaining to securities broking please write to
            complaints@ksxchange.com, for DP related to dp@ksxchange.com. Please
          ...
          <p>
            ...
            claiming to be part of KSXchange and offering such services, please
